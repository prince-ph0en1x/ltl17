...
class Terminal
{
	private String pathRepo = "/home/osboxes/eclipsejava/ltl17/";
	public int pno = 0;
	...
	public void RunCmd() throws Exception
	{
		...
		line = br.readLine();
		pathRepo = line.substring(0,line.lastIndexOf('/'))+"/";
	...
	public void ConvLabel(int h) throws Exception
	{
		...
		br = new BufferedReader(new FileReader(pathRepo+"optsm/Problem"+pno+"/hypothesis"+h+".dot"));
	...
	public void ProcLog() throws Exception
	{
		...
		br = new BufferedReader(new FileReader(pathRepo+"optsm/Problem"+pno+"/Log file.txt"));
